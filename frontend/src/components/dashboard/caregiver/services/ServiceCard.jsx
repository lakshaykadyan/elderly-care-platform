        ...
        <div className="sc-card">
          ...
          <div className="row" style={{ justifyContent: "space-between", marginBottom: "12px" }}>
            <div className="row" style={{ gap: "14px" }}>
              ...
              <div>
                ...
                <div className="row" style={{ gap: "14px", marginTop: "2px" }}>
                  <span style={{ fontSize: "13px", color: "#94a3b8" }}>📧 {service.userId?.email || "No email"}</span>
                  <span style={{ fontSize: "13px", color: "#94a3b8" }}>📞 {service.userId?.phone || "Not Available"}</span>
                </div>
              </div>
            </div>
            <div className="row" style={{ gap: "8px" }}>
              ...
              }}>{statusLabels[service.status] || service.status}</span>
            </div>
          </div>

          {/* Details Grid */}
          <div className="grid-4">
            <div><span className="label">📅 Date</span><span className="value">{formatDate(service.bookingDate)}</span></div>
            <div><span className="label">🕒 Time</span><span className="value">{service.bookingTime || "Not Set"}</span></div>
            <div><span className="label">⌛ Duration</span><span className="value">{service.duration || "Not Set"}</span></div>
            <div><span className="label">💰 Price</span><span className="value price">₹ {service.price || 0}</span></div>
            <div className="full"><span className="label">🏥 Service</span><span className="value">{service.serviceType}</span></div>
          </div>

          {/* Contact Buttons */}
          <div className="contact-btns">
            <a href={`tel:${service.userId?.phone || ""}`} className="call">📞 Call</a>
            <a href={`mailto:${service.userId?.email}`} className="email">✉ Email</a>
          </div>
          ...
          <div className="notes-box">
            <div className="row" style={{ justifyContent: "space-between", marginBottom: "8px" }}>
              <h4 style={{ fontSize: "14px", fontWeight: "600", margin: 0, color: "#f8fafc" }}>📝 Care Notes</h4>
